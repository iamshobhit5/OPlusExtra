...
public class CustomSeekBarPreference extends SliderPreference {
    ...
    public CustomSeekBarPreference(Context content, AttributeSet attrs) {
        super(content, attrs);
        readLegacyAttrs(content, attrs);
        initDefaults();
        mUserSummary = super.getSummary();
        updateSummaryNow();
    }

    public CustomSeekBarPreference(Context content) {
        super(content, null);
        initDefaults();
        mUserSummary = super.getSummary();
        updateSummaryNow();   
    ...
    private void readLegacyAttrs(Context c, AttributeSet attrs) {
        ...
        TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.CustomSeekBarPreference);
        try {
            ...
            final boolean continuous = a.getBoolean(R.styleable.CustomSeekBarPreference_continuousUpdates, false);
